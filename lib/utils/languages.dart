...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          'info': 'Info',
          'this_product_already_added_to_the_favorites':
              'This product already added to the favorites',
          'add_to_favorites': 'Add to favorites',
          'buy_now': 'Buy now',
          'handmade_colorful_ceramics': 'Handmade colorful ceramics',
          'this_text_is_an_example_of_text':
              'This text is an example of text that can be replaced by generating this text from the Arabic text generator...',
          ...
          'example_handmade_colorful_ceramics':
              'Example: Handmade colorful ceramics',
          'quantity': 'Quantity',
          ...
          'example__product_that_was_made':'Example: A product that was made with the best blessings...',
          'product_description':'Product Description',
          'price':'The price',
          'attach_a_picture':'Attach a picture',
          'add_a_product_image':'Add a product image',
        ...
        'ar': {
          ...
          'info': 'معلومات',
          'this_product_already_added_to_the_favorites':
              'تمت إضافة هذا المنتج بالفعل إلى المفضلة',
          ...
          'example__product_that_was_made':'مثال: منتج تم صناعته بافضل الخامات...',
          'product_description':'وصف المنتج',
          'price':'السعر',
          'attach_a_picture':'ارفق صورة',
          'add_a_product_image':'اضافة صورة المنتج',
          'accessories':'اكسسوارات',
          'select_product_category':'اختر فئة المنتج',
          'add':'اضافة',
        }
      };
}
